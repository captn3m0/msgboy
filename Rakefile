...
def manifest(destination = "")
  ...
  manifest = {
    ...
    :description => "Msgboy is a chrome extension that pushes to you your favorite content on the web. You can also train it so that eventually it will show only the most relevant content.",
