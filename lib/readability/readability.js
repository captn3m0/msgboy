...
var readability = {
	...
	**/
	...
	grabArticleFromElement: function(element, preserveUnlikelyCandidates) {
		/**
		...
		**/
		...
		{
			topCandidate = document.createElement("p");
			topCandidate.innerHTML = element.innerHTML;
			cleanElement = topCandidate;
		...
		**/
		...
		var siblingScoreThreshold = Math.max(10, topCandidate.readability.contentScore * 0.2);
			...
			if(typeof topCandidate.readability != 'undefined' && topCandidate.readability.contentScore >= siblingScoreThreshold)
			{
				append = true;
			}
			
			if(topCandidate.nodeName == "P") {
				var linkDensity = readability.getLinkDensity(topCandidate);
				var nodeContent = readability.getInnerText(topCandidate);
